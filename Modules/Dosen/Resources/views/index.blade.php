        ...
        <div class="card-header header-elements-inline">
            ...
            <div class="header-elements">
                <div class="btn-group">
                    ...
                    <button class="btn bg-warning" data-toggle="modal" data-target="#import">
                        <i class="icon-add"></i>
                        Import
                    </button>
                    <a class="btn bg-primary" href="{{ route('dosen.export', ['excel']) }}">
                        <i class="icon-add"></i>
                        Export Excel
                    </a>
                    <a class="btn bg-secondary" href="{{ route('dosen.export', ['pdf']) }}">
                        <i class="icon-add"></i>
                        Export PDF
                    </a>
                </div>
