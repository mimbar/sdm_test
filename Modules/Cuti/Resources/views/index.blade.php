            ...
            <table class="table table-hover table-sm dtpegawai" style="width: 100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center bg-{{ $item['bg'] }}">{{ $item['st'] }}</td>
                        @if ($item['status'] == 0)
                        <td>
                            <div class="btn-group">
                                <form action="{{ route('cuti.cuti.update', $item->id) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
                        ...
                        <td>
                            <div class="btn-group">
                                <button class="btn btn-sm btn-success" disabled type="button">Terima</button>
                                <button class="btn btn-sm btn-danger" disabled type="button">Tolak</button>
                            </div>
                        </td>
...
<div id="mUser" class="modal fade" tabindex="-1">
    <div class="modal-dialog modal-full">
        <div class="modal-content">
            ...
            <form action="{{ route('dosen.dosen.store') }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3">
                            <input type="text" class="form-control singleDP" name="tanggal_lahir"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3">
                            <select name="prodi[]" class="form-control" multiple>
                                {{-- @foreach($data['prodi'] as $data)
            ...
            <form action="{{ route('dosen.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="file" accept=".xls, .xlsx" class="form-control form-control-file" name="file">
                    </div>
                </div>
                <div class="modal-footer">
